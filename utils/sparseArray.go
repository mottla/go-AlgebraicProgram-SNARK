...
//	return b
//}
//func (self SparseArray) Size() uint {
//	return self.root.Size()
//}
//
//// Size return the height of tree with root `root`
//func (root *TreeNode) Size() uint {
//	if root == nil {
//		return 0
//	}
...
//
//			tmp := root.right.minNode()
//			root.Value = tmp.Value
//			root.right = root.right.delete(tmp.Key)
//			root.left = tmp.left
//			return root
//		} else {
//			tmp := root.left.maxNode()
//			root.Value = tmp.Value
...
//		//root.right = root.right.delete(tmp.Key)
//		//root.left = root.left.delete(tmp.Key)
//		//root.height = maximum(root.left.Size(), root.right.Size()) + 1
...
//	if isSmaler(key, root.Key) {
//		//if isEqual(key, root.left.Key) {
//		//	//root.left.Value = insertMode(root.Value, value)
//		//	return root.left.insert(key, value, insertMode)
//		//}
//
//		root.left, newNode = root.left.insert(key, value, insertMode)
//		var tmp *TreeNode
//		if root.left.Size()-root.right.Size() == 2 { // && !isEqual(key, root.left.Key) {
//
//			if isSmaler(key, root.left.Key) {
//				tmp = root.rightRotate()
//			} else {
//				tmp = root.leftRightRotate()
//			}
//			root = tmp
//		}
//	} else {
...
//		//if root.right.Size()-root.left.Size() == 2 {
...
//		//}
//		root.right, newNode = root.right.insert(key, value, insertMode)
//		if root.right.Size()-root.left.Size() == 2 { // && !isEqual(key, root.right.Key) {
//			if !isSmaler(key, root.right.Key) {
//				root = root.leftRotate()
//			} else {
//				root = root.rightLeftRotate()
//			}
